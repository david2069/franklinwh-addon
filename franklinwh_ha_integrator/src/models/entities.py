...
def get_entities_for_profile(profile_dict: dict) -> list[EntityDef]:
    """
    Return only the entities whose hw_requires flag is satisfied
    by the given GatewayProfile dict.
    """
