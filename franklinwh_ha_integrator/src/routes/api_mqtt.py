...
async def get_entity_prefix():
    ...
    return {
        ...
        "supported_tokens": [
            {"token": "{short_id}",     "description": "Last 8 chars of gateway serial",          "example": examples[0]["short_id"]     if examples else "99900001"},
            {"token": "{full_serial}",  "description": "Full gateway serial (sanitised)",          "example": _sanitise(examples[0]["full_serial"])  if examples else "99900000000099900001"},
